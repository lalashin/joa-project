...
$g4['server_time'] = date("Y-m-d H:i:s");
$check_time  = date("Y-m-d H:i:s");

if ($_SESSION['ss_shop_check_time']){
	$time_sel = date_sel_time($_SESSION['ss_shop_check_time']);

	if($time_sel['hour'] == 0 && $time_sel['min'] == 0){
		if($time_sel['sec'] >= 10){
			echo "<script>alert('쇼핑몰 신청은 10초 이내 연속해서 신청할수 없습니다. 잠시 기다려주세요');location.href='order.html'</script>";    
			exit;
		}else{
...
function PayResultView($type,$orderno,$orderday,$name,$hp,$url){
	...
	$ReceiptPrint= "&nbsp;&nbsp;<a href=\"javascript:showReceiptByTID('$pg_mid', '$row2[pg_tid]', '$authdata')\"><img src=\"http://joagift.co.kr/new/images/mail/tm_prt.gif\" align='absMiddle' alt='영수증출력'/></a>";
	$ReceiptPrint2= "&nbsp;&nbsp;<a href=\"https://pgweb.dacom.net/pg/wmp/etc/jsp/SettlementSearch.jsp\" target=\"_blank\"><img src=\"http://joagift.co.kr/new/images/mail/tm_prt.gif\" align='absMiddle' alt='영수증출력'/></a>";
		  ...
		  <div class="agency_result01">
			...
			<div class="sec02">
              <!-- 쇼핑몰신청완료 S-->        
                    ...
                    <div class="alC pd30T" style="padding-top:10px; padding-bottom:90px;">
	...
	<tr>
    	<td width='650px' align='center'>
			<div style='margin:0 auto; width:644px; border:3px solid #dcdcdc;'>
				<div style='width:644px; margin-bottom:20px;'><img src='http://joagift.co.kr/new/images/mail/admin_oktit.png' alt='쇼핑몰 신청을 환영합니다.' /></div>
                ...
                <div style='width:600px; margin:0 auto;'>
                    ...
                    <tr>
                    	<td colspan='2' align='left' style='border-bottom:2px solid #dcdcdc; '><img src='http://joagift.co.kr/new/images/mail/tm_01.gif' alt='신청자정보' /></td>
                    </tr>
                    <tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm01.gif' alt='성명' ></td>
                    ...
                    <tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm02.gif' alt='나이' ></td>
                    ...
                    <tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm03.gif' alt='연락처' ></td>
                    ...
                    <tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm04.gif' alt='주소' ></td>
                    ...
                    <table width='100%' cellpadding='0' cellspacing='0'>
                    <tr>
                    	<td colspan='2' align='left' style='border-bottom:2px solid #dcdcdc;'><img src='http://joagift.co.kr/new/images/mail/tm_02.gif' alt='결제정보' /></td>
                    </tr>
					<tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm06.gif' alt='결제시간' ></td>
...
$SMail	.=	"		<tr>
                    	<td style='border-bottom:1px dotted #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm07.gif' alt='납부금액' ></td>
					...
					<tr>
                    	<td style='border-bottom:2px solid #dcdcdc;' height='28' width='85'><img src='http://joagift.co.kr/new/images/mail/tm05.gif' alt='납부방법' ></td>
...
$SMail	.=	"		</tr>
                    ...
                    <img src='http://joagift.co.kr/new/images/mail/tm_info.gif' alt='신청진행사항'/>
                    </div>
...
//unset( $_SESSION['ss_shop_check_time'] );
